...
import team from "../AdminTeam/team.png"
import { Link } from "react-router-dom"
import { X, User, Mail, Phone, Building, CreditCard, Calendar, Trash2, Upload } from "lucide-react"
      ...
      <div className="flex justify-between items-center mb-6">
        <div className="flex items-center gap-3">
          <div className="bg-gray-800 p-3 rounded-xl">
            <img src={img || "/placeholder.svg"} className="h-10 w-14" alt="Vector" />
          </div>
          <div>
